const CACHE='prevencao-v3.11-cache-v1';
...
self.addEventListener('fetch',e=>{
  ...
  if(url.pathname.endsWith('/index.html') || url.pathname==='/' || url.pathname.endsWith('/manifest.json') || url.pathname.endsWith('/service-worker.js')){
